package com.xw.bilibili.domain.constant;
...
public interface UserConstant {
    ...
    public static final String DEFAULT_NICK = "mengxin";
    ...
    public static final String USER_FOLLOWING_GROUP_ALL_NAME = "All Followings";
